...
GLOBAL_GALAXY_COLLECTIONS="ibm.power_linux_sap:>=3.0.0,<4.0.0 ibm.power_aix:2.1.1 ibm.power_aix_oracle:1.3.3 ibm.power_aix_oracle_dba:2.0.9 ibm.power_aix_oracle_rac_asm:1.3.7 ansible.utils:6.0.0"
